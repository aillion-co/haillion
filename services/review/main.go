...
import (
	...
	"haillion/services/review/internal/api"
	"haillion/services/review/internal/repository"
...
func main() {
	...
	slog.Info("starting review service", "port", *port)
	...
	go func() {
		...
		slog.Info("shutting down review service gracefully...")
	...
	slog.Info("review service stopped successfully")
}
